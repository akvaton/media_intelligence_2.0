...
export const CalculateRegressionCoefficientAction = {
  icon: 'Sigma',
  actionType: 'bulk',
  ...
  component: AdminJS.bundle(
    '../../../src/adminjs/components/CalculateRegressionCoefficient.jsx',
  ),
};

export default CalculateRegressionCoefficientAction;
